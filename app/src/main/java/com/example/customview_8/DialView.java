...
public class DialView extends View {
    ...
    //untuk menyimpan lebar dan tinggi view
    private float mWidth;
    private float mHeight;

    //ibarat gambar canvas pake paint
    private Paint mTextPaint;
    private Paint mDialPaint;

    //Radius untuk width sma height  nya
    ...
    private void init(){
        ...
        setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                //setiap kali di klik activeselection akan nambah
    ...
    //method menghitung koordiat meletakkan label dan marker
